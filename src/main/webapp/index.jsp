                    ...
                    <ul>
                        <li>
                            <a href="${pageContext.request.contextPath}/AppServlet?mainAction=getItems&amp;subAction=getEarings"
                               target="Frame">Earings</a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/AppServlet?mainAction=getItems&amp;subAction=getBraslets"
                               target="Frame">Braslets</a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/AppServlet?mainAction=getItems&amp;subAction=getBreloques"
                               target="Frame">Breloque</a></li>
                        <li>
                            <a href="${pageContext.request.contextPath}/AppServlet?mainAction=getItems&amp;subAction=getWatches"
                               target="Frame">Watches</a></li>
                    </ul>
                </li>
